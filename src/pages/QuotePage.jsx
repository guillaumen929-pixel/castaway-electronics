...
export default function QuotePage() {
  ...
  return (
    <>
      ...
      {/* ─── TRUST BAR ─── */}
      <section className="py-10 bg-[#0D1B2A] border-b border-white/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            {TRUST_ITEMS.map(({ icon: Icon, label, desc }) => (
              <div key={label} className="flex flex-col items-center gap-2">
                <div className="w-10 h-10 rounded-full bg-[rgba(0,196,180,0.15)] flex items-center justify-center">
                  <Icon size={18} className="text-[#00C4B4]" />
                </div>
                <div className="font-head font-bold uppercase tracking-[0.04em] text-white text-sm">{label}</div>
              ...
              <div className="bg-[#112336] p-6 sm:p-10 lg:p-12 h-full relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-5">
                    ...
                    <a href="mailto:support@castawayelectronics.com" className="flex items-start gap-4 group">
              ...
              <div className="bg-white p-10 lg:p-12 h-full">
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="mb-2">
                      <Eyebrow tone="teal" className="mb-2">// Your Details</Eyebrow>
                      <h3 className="font-head font-bold uppercase tracking-[0.03em] text-xl text-[#0D1B2A]">Tell us about your needs</h3>
                      <p className="text-[#4A5568] font-body text-sm mt-1">All fields marked <span className="text-[#00C4B4]">*</span> are required.</p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-[#0D1B2A] font-body text-sm font-semibold uppercase tracking-[0.06em] mb-1.5">
                          First Name <span className="text-[#00C4B4]">*</span>
                        </label>
                        <input
                          type="text"
                          name="firstName"
                      ...
                      <div>
                        <label className="block text-[#0D1B2A] font-body text-sm font-semibold uppercase tracking-[0.06em] mb-1.5">
                          Last Name <span className="text-[#00C4B4]">*</span>
                        </label>
                        <input
                          type="text"
                          name="lastName"
                    ...
                    <div>
                      <label className="block text-[#0D1B2A] font-body text-sm font-semibold uppercase tracking-[0.06em] mb-1.5">
                        Service Needed <span className="text-[#00C4B4]">*</span>
                      </label>
                      <select
                        name="service"
